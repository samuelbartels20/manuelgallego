  ...
  return ( 
      <div className='menu'>
        ...
        <div className='social'>
          <a href='https://twitter.com/josheriff'><Twitter className='svg'/></a>
          <a href='https://www.linkedin.com/in/josheriff/'><Linkedin className='svg'/></a>
          <a href='https://github.com/josheriff/'><Github className='svg'/></a>
        </div>
      </div>
    );
}
